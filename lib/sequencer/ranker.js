...
const KIND_IMPACT = {
  ...
  state: 0.7,
  action: 0.6,
  // Below action on purpose: accepted Next criteria are the contract for the
  // current work, while the Record here is a headline pointing at
  // .intent/decisions.md. When the budget is tight the criteria must win.
  record: 0.55,
  reference: 0.4,
  context: 0.5,
};
