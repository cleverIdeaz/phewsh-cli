      ...
      if (remainingTokens > 50 && chunk.weight > 0.3) {
        ...
        for (const line of lines) {
          if (partial.length + line.length + 1 > charBudget) {
            // Never strand a semantic heading at the budget boundary. A
            // projection that says "Current Focus:" without the focus is more
            // misleading than a small soft-budget overrun. Allow one bounded
            // value line, then stop.
