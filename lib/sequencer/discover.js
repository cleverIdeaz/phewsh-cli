...
// decisions.md IS a source: it is the canonical Record — the fourth word, and
// the file `phewsh remember` writes. Leaving it out made every projection carry
// Project and Next while silently dropping what the last session learned.
const INTENT_FILES = ['vision.md', 'plan.md', 'status.md', 'next.md', 'decisions.md'];
